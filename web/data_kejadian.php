...
//authentication();
$kon = koneksi_db();
$query = mysqli_query($kon, "SELECT * FROM `kejadian` ORDER BY `kejadian`.`id_kejadian`  DESC");
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="name" data-editable="true">ID Masyarakat Pelapor</th>
                                        <th data-field="company" data-editable="true">Waktu Kejadian</th>
                                        <th data-field="price" data-editable="true">Longitude</th>
                                        <th data-field="date" data-editable="true">Latitude</th>
                                        <th data-field="task" data-editable="true">Deskripsi</th>
                                ...
                                <tbody>
                                    ...
                                    while ($result = mysqli_fetch_object($query)) {
                                        ...
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $result->id_masyarakat_pelapor ?></td>
