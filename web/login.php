                ...
                <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="hpanel">
                        <div class="panel-body">
                            <form action="index.php" id="proses_login">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="password">Nama</label>
                                    <input type="text" title="Please enter your name" placeholder="Nama Anda"  required="" value="" name="name" id="nama" class="form-control">
